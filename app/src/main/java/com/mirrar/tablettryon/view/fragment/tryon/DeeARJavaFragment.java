...
public class DeeARJavaFragment extends Fragment implements SurfaceHolder.Callback, AREventListener {

    private FragmentDeepArBinding binging;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binging = FragmentDeepArBinding.inflate(inflater, container, false);
    ...
    public void onStart() {
        if (ContextCompat.checkSelfPermission(requireContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED ||
            ...
            ActivityCompat.requestPermissions(requireActivity(), new String[]{Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO},
                    1);
        } else {
...
//        ImageButton nextMask = findViewById(R.id.nextMask);
        ...
        SurfaceView arView = binging.surface;
...
/*
    ...
    private void initializeDeepAR() {
        deepAR = new DeepAR(requireContext());
    ...
    private void bindImageAnalysis(@NonNull ProcessCameraProvider cameraProvider) {
        ...
        if (useExternalCameraTexture) {
            ...
            if (surfaceProvider == null) {
                surfaceProvider = new ARSurfaceProvider(requireContext(), deepAR);
            }
